<?php if(isset($_GET['id']) && $_GET['id'] >= 0) require_once(__DIR__.'/item.php'); else { 
	$this->list = array();
	$this->model->category->getAll($this->list,0,'');
?>
<div class="block"><form method="post">
	<table class="list-data">
		<tr><th width="10">ID</th><th align="left">Danh mục sản phẩm & dịch vụ</th><th align="left">Đường dẫn</th><th width="100">Nổi bật</th><th width="100">Trạng thái</th><th width="110"><a href="?page=category&id=0">THÊM MỚI</a></th></tr>
		<?php foreach($this->list as $item) : ?>
		<tr>
			<td><?php echo $item->id; ?></td>
			<td class="name"><a href="?page=category&id=<?php echo $item->id; ?>"><?php echo $item->prefix.$item->name; ?></a></td>
			...
			<td align="center">
				<a href="?page=category&id=<?php echo $item->id; ?>"><i class="ion-android-open"></i></a>
