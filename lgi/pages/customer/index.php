<?php if(!empty($this->item)) require_once('item.php'); else {?>
	<div class="block">
		<form method="post" class="frm-post">
			<div class="row">
				<div class="col col-4"><div class="ipg"><label>Tên khách hàng</label><input type="text" name="name" required></div></div>
				<div class="col col-4"><div class="ipg"><label>Số điện thoại</label><input type="text" name="phone" pattern="[0-9]{10,11}" required class="isPhone"></div></div>
				<div class="col col-4">
					<div class="ipg field">
