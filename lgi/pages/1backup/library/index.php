...
if(isset($_GET['id']) && $_GET['id'] >= 0) require_once(__DIR__.'/item.php'); else { 
	...
	$this->list = $this->model->library->getList($search, $this->total, $this->pagina, $this->limit, $status);
	$this->pages = ceil($this->total / $this->limit);
?>
<div class="block"><form method="post">
	<table class="list-data">
		<tr><th width="10">ID</th><th align="left">Thư viện</th><th width="100">Lượt xem</th><th width="100">Cập nhật</th><th width="100">Nổi bật</th><th width="100">Trạng thái</th><th width="110"><a href="?page=library&id=0">THÊM MỚI</a></th></tr>
		<?php foreach($this->list as $item) : ?>
		<tr>
			<td><?php echo $item->id; ?></td>
			<td class="name"><a href="?page=library&id=<?php echo $item->id; ?>"><?php echo $item->name; ?></a></td>
			...
			<td align="center">
				<a href="?page=library&id=<?php echo $item->id; ?>"><i class="ion-android-open"></i></a>
