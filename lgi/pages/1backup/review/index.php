...
if(isset($_GET['id']) && $_GET['id'] >= 0) require_once(__DIR__.'/item.php'); else { 
	...
	$this->list = $this->model->review->getList($search, $status, $this->total, $this->pagina, $this->limit);
	$this->pages = ceil($this->total / $this->limit);
?>
<div class="block"><form method="post">
	<table class="list-data">
		<tr><th width="10">ID</th><th align="left">Đánh giá</th><th width="100">Họ tên</th><th width="100">Điện thoại</th><th width="100">Thời gian</th><th width="100">Nổi bật</th><th width="100">Trạng thái</th><th width="100"></th></tr>
		<?php foreach($this->list as $item) : ?>
		<tr>
			<td><?php echo $item->id; ?></td>
			<td class="name"><a href="?page=review&id=<?php echo $item->id; ?>">[<?php echo $item->rate; ?> SAO] <?php echo $item->content; ?></a></td>
			...
			<td align="center">
				<a href="?page=review&id=<?php echo $item->id; ?>"><i class="ion-android-open"></i></a>
