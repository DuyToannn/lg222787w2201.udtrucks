				...
				editor.addCommand( 'insertToc', {
					...
					exec: function( editor )
					{
						...
						for ( var i = 0 ; i < nodes.count() ; i++ )
						{
							...
							tocItems = tocItems + '<div class="level-'+level*40+'" id="' + id.toString() + '-toc" name="tableOfContents">' + '<a href="#' + id.toString() + '">' + text.getText().toString() + '</a></div>';
						}

						//output toc
						var tocNode = '<div name="tableOfContents" id="tableOfContents"><p class="title"><b>' + editor.lang.toc.ToC + '</b></p>' + tocItems + '</div>';
